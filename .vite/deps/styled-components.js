		...
		if (a2) {
			...
			if (c2) {
				var l2 = 0 | parseInt(c2[1], 10),
					u2 = c2[2];
				0 !== l2 &&
					(Se(u2, l2), Ee(e, u2, c2[3]), e.getTag().insertRules(l2, r2)),
					(r2.length = 0);
			} else r2.push(a2);
		}
	}
...
var Re = (function () {
	function e(e2, n, o2) {
		...
		var r2 = this;
		(this.options = __assign(__assign({}, De), e2)),
			(this.gs = n),
			...
			!this.server &&
				...
				(function (e3) {
					for (
						var t = document.querySelectorAll(we), n2 = 0, o3 = t.length;
						n2 < o3;
						n2++
					) {
						var r3 = t[n2];
						r3 &&
							r3.getAttribute(f) !== m &&
							(Ne(e3, r3), r3.parentNode && r3.parentNode.removeChild(r3));
					}
				})(this)),
			ue(this, function () {
				return (function (e3) {
...
function xe(e) {
	...
	u2.push(function (e2) {
		e2.type === RULESET &&
			e2.value.includes('&') &&
			(e2.props[0] = e2.props[0].replace(Te, n).replace(o2, l2));
	}),
...
function Le(e) {
	...
	return import_react.default.createElement(
		Me.Provider,
		{ value: d },
		import_react.default.createElement(ze.Provider, { value: u2 }, e.children)
	);
}
var Ge = (function () {
	function e(e2, t) {
	...
	for (var s2 in t) {
		...
		t.hasOwnProperty(s2) &&
			...
			((Array.isArray(i2) && i2.isCss) || re(i2)
				? r2.push(''.concat(We(s2), ':'), i2, ';')
				: ce(i2)
					? r2.push.apply(
							r2,
							__spreadArray(
								__spreadArray([''.concat(s2, ' {')], He(i2), false),
								['}'],
								false
							)
						)
							...
							''
								...
								.concat(
									...
									null == (o2 = i2) || 'boolean' == typeof o2 || '' === o2
										...
										: 'number' != typeof o2 ||
											  0 === o2 ||
											  n in emotion_unitless_esm_default ||
											  n.startsWith('--')
											? String(o2).trim()
											: ''.concat(o2, 'px')),
									';'
		...
		(e.prototype.generateAndInjectStyles = function (e2, t, n) {
			...
			if (this.isStatic && !n.hash)
				if (
					...
					var r2 = ae(Ue(this.rules, e2, t, n)),
...
function tt(e) {
	var n = import_react.default.useContext(Ke),
	...
	return e.children
		? import_react.default.createElement(Ke.Provider, { value: r2 }, e.children)
		: null;
}
var nt = {};
	...
	function O2(e2, r3) {
		return (function (e3, r4, s3) {
			var i3 = e3.attrs,
				...
				h2 = e3.target,
				f3 = import_react.default.useContext(Ke),
				m3 = Be(),
...
var pt = (function () {
	...
	return (
		(e.prototype.createStyles = function (e2, t, n, o2) {
			var r2 = o2(ae(Ue(this.rules, t, n, o2)), ''),
		...
		(e.prototype.renderStyles = function (e2, t, n, o2) {
			e2 > 2 && Re.registerId(this.componentId + e2),
...
function dt(n) {
	...
	var i2 = at.apply(void 0, __spreadArray([n], r2, false)),
		a2 = 'sc-global-'.concat(z(JSON.stringify(i2))),
		c2 = new pt(i2, a2);
	P(a2);
	var l2 = function (e) {
		var t = Be(),
			n2 = import_react.default.useContext(Ke),
...
function ht(t) {
	...
	var r2 = ae(at.apply(void 0, __spreadArray([t], n, false))),
		s2 = z(r2);
	return new Ge(s2, r2);
}
function ft(e) {
...
var mt = (function () {
	function e() {
		...
		(this._emitSheetCSS = function () {
			...
			(this.instance = new Re({ isServer: true })),
			(this.sealed = false);
	}
	return (
