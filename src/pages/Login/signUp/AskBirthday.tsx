	...
	return (
		<>
			...
			<Div className="text">
				...
				다른 사람에게 공개되지 않습니다.{' '}
				<Span className='why' onClick={()=>setIsModalOpen(true)}>왜 생년월일을 입력해야 하나요?</Span>
			</Div>
			<Input
				isvalid={isValid}
				type="date"
